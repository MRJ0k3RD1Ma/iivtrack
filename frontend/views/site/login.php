...
<div class="auth-content my-auto">
    ...
    <?php $form = ActiveForm::begin(['id' => 'login-form','options'=>['class'=>'mt-4 pt-2']]); ?>
        ...
        <div class="form-floating form-floating-custom mb-4">
            <input type="text" class="form-control" name="LoginForm[username]" id="loginform-username" placeholder="Telefon raqamingizni kiriting">
            <label for="loginform-username">Telefon</label>
...
<?php
$this->registerJs("
    IMask(document.getElementById(\"loginform-username\"), {mask: \"(00)000-0000\"})
")
?>